...
<script lang="ts">
  ...
  type ArrayOfStringOrObject = string[] | Record<string, unknown>[];
  ...
  export default defineComponent({
    ...
    props: {
      data: {
        type: Array as PropType<ArrayOfStringOrObject>,
        default: () => [],
        required: true,
      },
      label: {
    ...
    setup(props) {
      ...
      const list = computed<{ initial: ArrayOfStringOrObject; rest: ArrayOfStringOrObject; len: number }>(() => {
